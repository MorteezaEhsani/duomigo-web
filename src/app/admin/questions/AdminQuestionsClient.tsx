      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 mb-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Admin - Add Questions</h1>
              <p className="text-sm text-gray-600 mt-1">Add new practice questions to the database</p>
            </div>
            <button
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
          ...
          <div className="mt-8 p-4 bg-blue-50 rounded-lg">
            ...
            <ul className="text-sm text-blue-800 space-y-1">
              <li>• <strong>Listen Then Speak:</strong> Audio will be generated from the prompt text</li>
              <li>• <strong>Speak About Photo:</strong> Requires an image URL (upload to Supabase storage first)</li>
              <li>• <strong>Read Then Speak:</strong> Text will be displayed for reading</li>
              <li>• Difficulty: 1 = Beginner, 3 = Intermediate, 5 = Advanced</li>
              <li>• Users must speak between Min and Max seconds</li>
            </ul>
          </div>
        </div>
      </div>
